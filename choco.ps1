# Win+X, click Windows PowerShell (Admin)
# powershell.exe D:\choco.ps1
...
## disable hibernation, swap, system restore
...
## disable services
Get-ScheduledTask -TaskName *defrag* | Disable-ScheduledTask # disable defrag (no need when having an SSD)
Disable-BingSearch
Disable-GameBarTips
Disable-PSRemoting
